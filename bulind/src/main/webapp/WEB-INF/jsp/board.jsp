...
<body>
        ...
        <div class="row" id="body">
            <div class="col-1">
                <ul class="list-unstyled text-center">
                    ...
                    <a class="text-decoration-none" href="#"><li class="p-2"><h5 class="fw-bold">게시판</h5></li></a>
                </ul>
            </div>
            <div class="col-10">
                <div class="row pt-2">
                ...
                <div class="row">
                    <table class="table table-condensed w-auto" id="tableBoard">
                        <thead>
                            <tr>
                            <th scope="col">제목</th>
                            <th scope="col">내용</th>
    ...
    <script>
        $(function(){
            $.ajax({
                type: "GET",
                url: "http://localhost:8080/demo/board/article",
                async: true,
                dataType: "JSON",
